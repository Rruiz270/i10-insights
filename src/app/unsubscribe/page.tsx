          ...
          {!valid ? (
            <>
              ...
              <p className="mt-3 text-sm leading-relaxed text-gray-600">
                Este link de cancelamento e invalido ou expirou. Se voce
                acredita que isso e um erro, entre em contato conosco.
              </p>
            </>
          ) : (
            <>
